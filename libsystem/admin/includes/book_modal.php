    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">About Book</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Book Image</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Book PDF</label>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="type" id="type" required>
                      <option value="" selected id='typeselect'></option>
                ...
                <b>NOTE : </b> If you Update Book Title, You Need To Update Or Re-Upload The book File
