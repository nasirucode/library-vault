        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label for="student" class="col-sm-3 control-label">USERNAME</label>
                ...
                <div class="form-group">
                    <label for="student" class="col-sm-3 control-label">PASSWORD</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="student" name="student" required>
                    </div>
                </div>
                <b>NOTE : </b><i> Your Firstname is ur username and ur id is ur password.</i>
            </div>
